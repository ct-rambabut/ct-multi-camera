package com.example.multicameralibrary.camera;
...
import com.example.multicameralibrary.R;
import com.example.multicameralibrary.camera.controls.Audio;
import com.example.multicameralibrary.camera.controls.AudioCodec;
import com.example.multicameralibrary.camera.controls.Control;
import com.example.multicameralibrary.camera.controls.ControlParser;
import com.example.multicameralibrary.camera.controls.Engine;
import com.example.multicameralibrary.camera.controls.Facing;
import com.example.multicameralibrary.camera.controls.Flash;
import com.example.multicameralibrary.camera.controls.Grid;
import com.example.multicameralibrary.camera.controls.Hdr;
import com.example.multicameralibrary.camera.controls.Mode;
import com.example.multicameralibrary.camera.controls.PictureFormat;
import com.example.multicameralibrary.camera.controls.Preview;
import com.example.multicameralibrary.camera.controls.VideoCodec;
import com.example.multicameralibrary.camera.controls.WhiteBalance;
import com.example.multicameralibrary.camera.engine.Camera1Engine;
import com.example.multicameralibrary.camera.engine.Camera2Engine;
...
import com.example.multicameralibrary.camera.engine.orchestrator.CameraState;
import com.example.multicameralibrary.camera.filter.Filter;
import com.example.multicameralibrary.camera.filter.FilterParser;
import com.example.multicameralibrary.camera.filter.Filters;
import com.example.multicameralibrary.camera.filter.NoFilter;
import com.example.multicameralibrary.camera.filter.OneParameterFilter;
import com.example.multicameralibrary.camera.filter.TwoParameterFilter;
import com.example.multicameralibrary.camera.frame.Frame;
import com.example.multicameralibrary.camera.frame.FrameProcessor;
import com.example.multicameralibrary.camera.gesture.Gesture;
import com.example.multicameralibrary.camera.gesture.GestureAction;
import com.example.multicameralibrary.camera.gesture.GestureFinder;
import com.example.multicameralibrary.camera.gesture.GestureParser;
import com.example.multicameralibrary.camera.gesture.PinchGestureFinder;
import com.example.multicameralibrary.camera.gesture.ScrollGestureFinder;
import com.example.multicameralibrary.camera.gesture.TapGestureFinder;
import com.example.multicameralibrary.camera.internal.CropHelper;
import com.example.multicameralibrary.camera.internal.GridLinesLayout;
import com.example.multicameralibrary.camera.internal.OrientationHelper;
import com.example.multicameralibrary.camera.markers.AutoFocusMarker;
import com.example.multicameralibrary.camera.markers.AutoFocusTrigger;
import com.example.multicameralibrary.camera.markers.MarkerLayout;
import com.example.multicameralibrary.camera.markers.MarkerParser;
...
import com.example.multicameralibrary.camera.preview.CameraPreview;
import com.example.multicameralibrary.camera.preview.FilterCameraPreview;
import com.example.multicameralibrary.camera.preview.GlCameraPreview;
import com.example.multicameralibrary.camera.preview.SurfaceCameraPreview;
import com.example.multicameralibrary.camera.preview.TextureCameraPreview;
import com.example.multicameralibrary.camera.size.AspectRatio;
import com.example.multicameralibrary.camera.size.Size;
import com.example.multicameralibrary.camera.size.SizeSelector;
import com.example.multicameralibrary.camera.size.SizeSelectorParser;
import com.example.multicameralibrary.camera.size.SizeSelectors;
