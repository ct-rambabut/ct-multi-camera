package com.example.multicameralibrary.camera.engine.action;
 ...
 * to all {@link Action}s. See {@link com.example.multicameralibrary.camera.engine.Camera2Engine} for
 * our implementation.
 */
